    ...
    <div class="flex-1 overflow-y-auto p-8">
      ...
      <div v-if="isLoading" class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-12 shadow-lg border border-gray-200 text-center">
          ...
          <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl flex items-center justify-center mx-auto mb-6 animate-pulse">
          ...
          <div class="max-w-md mx-auto space-y-3">
            ...
            <div class="ml-4 border-l-2 border-emerald-200 h-6"></div>


            <div class="flex items-center gap-3">


              <div class="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center animate-bounce">
        ...
        <div class="bg-red-50 rounded-2xl p-8 border border-red-200">
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <h3 class="font-bold text-red-900 mb-2">出错啦</h3>
      ...
      <div v-else-if="result" class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          ...
          <div class="grid grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-4">
              ...
              <div class="text-2xl font-bold text-emerald-700">{{ result.statistics.total_findings }}</div>


              <div class="text-sm text-emerald-600">发现问题</div>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-4">
              ...
              <div class="text-2xl font-bold text-emerald-700">{{ (result.statistics.average_confidence * 100).toFixed(0) }}%</div>


              <div class="text-sm text-emerald-600">平均置信度</div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4">
              ...
              <div class="text-sm text-green-600">综合风险</div>
          ...
          <div>
            ...
            <h4 class="font-semibold text-gray-900 mb-3 flex items-center gap-2">
              ...
              <Sparkles :size="18" class="text-emerald-500" />
            ...
            <div class="flex flex-wrap gap-2">
              ...
              >
                ...
                <span class="text-sm text-emerald-600 font-bold">{{ count }}</span>
        ...
        <div v-if="result.recommendations.length > 0" class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 shadow-lg border border-emerald-200">
              ...
              >
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-4 mt-2 text-xs text-gray-500">
                    ...
                    <span v-if="finding.risk_score">风险值 {{ (finding.risk_score * 100).toFixed(0) }}</span>
...
.bg-red-50, .bg-orange-50, .bg-emerald-50, .bg-green-50, .bg-teal-50, .bg-yellow-50 {
...
.bg-red-50:hover, .bg-orange-50:hover, .bg-emerald-50:hover, .bg-green-50:hover, .bg-teal-50:hover, .bg-yellow-50:hover {
